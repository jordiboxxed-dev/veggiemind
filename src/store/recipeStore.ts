...
const mockRecipes: Recipe[] = [
  ...
  {
    id: '23',
    title: 'Pasta alla Norma Vegana',
    ingredients: [
      { name: 'Pasta (rigatoni o penne)', quantity: '200g' },
      { name: 'Berenjena', quantity: '1 grande' },
      { name: 'Tomates pelados en lata', quantity: '400g' },
      { name: 'Ajo', quantity: '2 dientes' },
      { name: 'Albahaca fresca', quantity: 'un manojo' },
      { name: 'Anacardos crudos (remojados)', quantity: '1/2 taza' },
      { name: 'Zumo de limón', quantity: '1 cda' },
      { name: 'Levadura nutricional', quantity: '1 cda' },
    ],
    nutrition: { calories: 580, protein: 20, carbs: 90, fat: 15 },
    difficulty: 'medio',
    cookTime: 35,
    servings: 2,
    preparation: "Corta la berenjena en cubos, sálala y déjala reposar 15 min. Sécala y fríela en aceite hasta que esté dorada. Aparte, sofríe el ajo, añade los tomates y cocina la salsa por 15 min con albahaca. Para la 'ricotta', tritura los anacardos remojados con limón, levadura nutricional y un poco de agua. Cuece la pasta, mézclala con la salsa y la berenjena. Sirve con la 'ricotta' de anacardos por encima.",
    kaiaTips: ['Remojar los anacardos al menos 2 horas en agua caliente los ablanda para una \'ricotta\' más cremosa.', 'No tengas miedo de usar una buena cantidad de aceite de oliva para freír la berenjena, es clave para el sabor.'],
    imageUrl: '/placeholder.svg',
    tags: ['balanced', 'soy-free'],
  },
  {
    id: '24',
    title: 'Enchiladas Verdes de Frijoles y Maíz',
    ingredients: [
      { name: 'Tortillas de maíz', quantity: '8' },
      { name: 'Frijoles negros cocidos', quantity: '1 lata' },
      { name: 'Maíz dulce', quantity: '1 taza' },
      { name: 'Tomatillos', quantity: '500g' },
      { name: 'Chile serrano o jalapeño', quantity: '1' },
      { name: 'Cilantro fresco', quantity: '1/2 taza' },
      { name: 'Cebolla blanca', quantity: '1/2' },
      { name: 'Queso vegano para gratinar', quantity: '1 taza' },
    ],
    nutrition: { calories: 500, protein: 18, carbs: 85, fat: 12 },
    difficulty: 'medio',
    cookTime: 40,
    servings: 4,
    preparation: "Hierve los tomatillos y el chile hasta que estén blandos. Licúalos con cilantro, un trozo de cebolla y sal para hacer la salsa verde. En un bol, mezcla los frijoles y el maíz. Pasa las tortillas por aceite caliente para ablandarlas, rellénalas con la mezcla de frijoles, enróllalas y colócalas en una fuente para horno. Baña con la salsa verde, cubre con queso vegano y hornea a 180°C por 20 minutos.",
    kaiaTips: ['Asar los tomatillos en lugar de hervirlos le da a la salsa un sabor ahumado delicioso.', 'Sirve con aguacate y "crema" vegana por encima.'],
    imageUrl: '/placeholder.svg',
    tags: ['high-protein', 'gluten-free', 'soy-free', 'nut-free'],
  },
];
